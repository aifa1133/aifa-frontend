...
export default function CourseCard() {
  ...
  return (
    <>
      <section className="w-full bg-[#0F1112] flex justify-center py-[40px] sm:py-[64px]">
        <div className="w-full max-w-[1400px] px-[16px] sm:px-[24px] md:px-[40px] lg:px-0">
 ...
 rounded-tl-[10px]
  ...
  "
        ...
        "
                    >
                      Master AI-powered filmmaking from concept to final cut
                      while learning how to create stunning, high-quality films
                      faster using cutting-edge AI tools.
                    </p>
                  </div>
  ...
  "
      ...
      {/* Mobile */}
      <section className="block lg:hidden w-full bg-[#0F1112] py-[40px]">

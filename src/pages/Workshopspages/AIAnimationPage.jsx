      ...
      <section className="w-full bg-[#0F1112]">
        ...
        "
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              {
                title: "Animation Storyboarding",
                desc: "Plan scenes and organize your animation workflow before production.",
              },
              {
                title: "Prompt Engineering",
                desc: "Write effective prompts to generate consistent animated characters and scenes.",
              },
              {
                title: "Character & Scene Design",
                desc: "Create animated characters, environments, and visual assets using AI.",
              },
              {
                title: "AI Animation Creation",
                desc: "Bring static images to life with smooth AI-powered animation techniques.",
              },
              {
                title: "Voiceovers & Sound Design",
                desc: "Add AI voiceovers, background music, and cinematic sound effects.",
              },
              {
                title: "Editing & Final Export",
                desc: "Edit, enhance, and export professional animated videos ready for publishing.",
              },
            ].map((item) => (
              <div
                key={item.title}
              ...
              {[
                {
                  ...
                  desc: "Produce scroll-stopping animated reels and videos faster using AI.",
                },
                {
                  title: "FILMMAKERS & ANIMATORS",
                  desc: "Level up your storytelling with AI-powered animation and cinematic workflows.",
                },
                {
                  title: "DESIGNERS & CREATIVE PROFESSIONALS",
                  desc: "Expand your creative skillset with AI-driven visuals, characters, and animation workflows.",
                },
                {
                  title: "FREELANCERS & AGENCY OWNERS",
                  desc: "Offer AI animation services and grow your creative business with premium projects.",
                },
                {
                  title: "AD & MARKETING PROFESSIONALS",
                  desc: "Create high-converting animated advertisements and brand campaigns using AI tools.",
                },
                {
                  title: "SOCIAL MEDIA MANAGERS",
                  desc: "Learn practical AI animation skills to create engaging content for digital platforms.",
                },
              ].map((item) => (
                <div
                  key={item.title}

      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex justify-between items-center mb-12 flex-wrap gap-4">
          ...
          <div className="flex gap-4">
            <select value={category} onChange={e=>{setCategory(e.target.value);setVisible(PAGE_SIZE);}} className="bg-[#111] border border-white/10 px-4 py-2 rounded-md text-white">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {prompts.filter(p => category === "All" || p.category === category).slice(0, visible).map((item, i) => (
            <div
              key={i}
        ...
        {/* 🔥 LOAD MORE */}
        {visible < prompts.filter(p => category === "All" || p.category === category).length && (

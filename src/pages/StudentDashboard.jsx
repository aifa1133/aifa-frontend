                  ...
                  <div className="flex items-center justify-between gap-3 px-5 py-4 bg-[#C7E36B]/30 flex-wrap">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        {fmtTimeRange && <p className="text-[#6E7072] text-[11px] font-semibold">at {fmtTimeRange}</p>}
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      {w.zoomLink ? (
                      ...
                      {calLink && (
                        <a href={calLink} target="_blank" rel="noreferrer" onClick={e => e.stopPropagation()}
                          className="flex items-center gap-1.5 bg-white text-[#0F1112] font-bold text-sm px-4 py-2.5 rounded-xl hover:bg-gray-100 transition border border-gray-200 whitespace-nowrap">

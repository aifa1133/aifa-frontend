  ...
  return (
    <div className="p-6">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="mt-8 flex items-center gap-4 bg-[#0F1112] border border-white/10 rounded-2xl px-5 py-4 hover:border-[#25D366]/40 hover:bg-[#25D366]/5 transition-all group"
      >
        ...
        <div className="flex-1">
          <p className="text-white font-bold text-sm">Need help with a workshop?</p>
          <p className="text-gray-400 text-xs mt-0.5">Chat with us on WhatsApp — +91 90520 88000</p>
        </div>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="text-gray-500 group-hover:text-[#25D366] transition-colors shrink-0">

            ...
            {workshop.previewVideoUrl ? (
              ...
              <>
                <div style={{padding:"56.37% 0 0 0", position:"relative"}}>
                  <iframe src="https://player.vimeo.com/video/1229658092?badge=0&autopause=0&player_id=0&app_id=58479&loop=1&title=0&byline=0&portrait=0"
                    frameBorder="0"
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6" ref={heroRef}>
            ...
            <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10">
              ...
              <div className="p-6">
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-2 mb-3">
                    <div className="w-5 h-5 rounded-full border border-[#C7E36B]/60 flex items-center justify-center shrink-0 mt-0.5">
                      <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#C7E36B" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                    </div>
                    <p className="text-sm text-gray-400">{b}</p>
                  </div>
                ))}
        ...
        {workshop.previewVideoUrl && getYouTubeId(workshop.previewVideoUrl) ? (
          ...
          <div className="rounded-2xl overflow-hidden mb-8" style={{padding:"56.37% 0 0 0", position:"relative"}}>
            <iframe
              src="https://player.vimeo.com/video/1229658092?badge=0&autopause=0&player_id=0&app_id=58479&loop=1&title=0&byline=0&portrait=0"
              frameBorder="0"
              allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"
              referrerPolicy="strict-origin-when-cross-origin"
              style={{position:"absolute",top:0,left:0,width:"100%",height:"100%"}}

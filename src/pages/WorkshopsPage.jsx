...
export default function WorkshopsPage() {
  ...
  const handleChat = () => {
    ...
    const message = "Hi, I need help choosing the right AI workshop.";
  ...
  return (
    <>
      ...
      <section className="bg-[#0B0F10] text-white py-10 md:py-16">
        <div className="max-w-[1180px] mx-auto px-4">
          <h1
            className="
            text-[#E5E7EB]
                ...
                <div className="flex flex-col md:flex-row gap-[6px] w-full">
                  ...
                  >
                    <img
                      ...
                      "
                      onError={(e) => {
                        e.currentTarget.src = "/workshops/placeholder.webp";
                      }}
                    />
      ...
      >
        ...
        >
          ...
          >
            ...
            "
            >
              Not sure which workshop is
              <br className="hidden md:block" /> right for you?
            </h2>
